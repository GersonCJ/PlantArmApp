...
List<DropdownMenuItem<String>> get dropdownItems {
  List<DropdownMenuItem<String>> menuItems = [
    const DropdownMenuItem(value: 'Choose...', child: Text('Choose...')),
    const DropdownMenuItem(value: 'VEG', child: Text('VEG')),
    const DropdownMenuItem(value: 'BLOOM', child: Text('BLOOM')),
    const DropdownMenuItem(value: 'VEG+BLOOM', child: Text('VEG+BLOOM')),
  ];
  return menuItems;
}
